 ...
 */
        ...
        String s[] = {" < 7000","7000 – 10000","10000 – 13000","13000 – 16000"," > 16000"};
        String n[] = {" 0 "," 1 "," 2 "," 3 "," 4 "," > 4 " };
        float a=(float) 2.5;
        int b=7;
        int c[][] =new int[5][6];
        int sum =0;
...
private void showProblem(boolean withUserdata)
{
        ...
        b=7;
        bb.setFontSize(15);
        bb.drawRectangle(charGapX*3,(int)(lineGapY*1.5),charGapX*16,(int)(lineGapY*3.5));
        bb.drawLine(charGapX*3,(int)(lineGapY*2.5) ,((charGapX*3) +(charGapX*16)),(int)(lineGapY*2.5));
        bb.drawLine(charGapX*3,(int)(lineGapY*3.0) ,((charGapX*3) +(charGapX*16)),(int)(lineGapY*3.0));
        bb.drawLine(charGapX*3,(int)(lineGapY*3.5) ,((charGapX*3) +(charGapX*16)),(int)(lineGapY*3.5));
        bb.drawLine(charGapX*3,(int)(lineGapY*4.0) ,((charGapX*3) +(charGapX*16)),(int)(lineGapY*4.0));
        bb.drawLine(charGapX*3,(int)(lineGapY*4.5) ,((charGapX*3) +(charGapX*16)),(int)(lineGapY*4.5));
        bb.drawLine(charGapX*7,(int)(lineGapY*2.0) ,((charGapX*3) +(charGapX*16)),(int)(lineGapY*2.0));
        bb.drawLine(((charGapX*3) +(charGapX*4)) , (int)(lineGapY*1.5),((charGapX*3) +(charGapX*4)),(int)(lineGapY*5.0));
        bb.drawLine(((charGapX*3) +(charGapX*6)) , (int)(lineGapY*2.0),((charGapX*3) +(charGapX*6)),(int)(lineGapY*5.0));
        bb.drawLine(((charGapX*3) +(charGapX*8)) , (int)(lineGapY*2.0),((charGapX*3) +(charGapX*8)),(int)(lineGapY*5.0));
        bb.drawLine(((charGapX*3) +(charGapX*10)) , (int)(lineGapY*2.0),((charGapX*3) +(charGapX*10)),(int)(lineGapY*5.0));
        bb.drawLine(((charGapX*3) +(charGapX*12)) , (int)(lineGapY*2.0),((charGapX*3) +(charGapX*12)),(int)(lineGapY*5.0));
        bb.drawLine(((charGapX*3) +(charGapX*14)) , (int)(lineGapY*2.0),((charGapX*3) +(charGapX*14)),(int)(lineGapY*5.0));
        bb.writeString("Monthly Income ",charGapX*3 + 10,(int)(lineGapY*1.5 + 10),false);
        bb.writeString("Vehicles per family ",charGapX*11,(int)(lineGapY*1.5),false);
        bb.writeString("(in Rs.) ",charGapX*4 + 10,(int)(lineGapY*2.0),false);
         
        for(int p=0;p<6;p++){
            if(p<5)
                bb.writeString(s[p],charGapX*3 + 10,(int)(lineGapY*a+5),false);
                bb.writeString(n[p],charGapX*b + 20,(int)(lineGapY*2.0+5),false);
            a+=0.5;
            b+=2;
        }
        ...
        if(mode == demoMode || mode == guidedMode || mode == testMode){
            ...
            for(int m=0;m<5;m++){
                b=7;
                for(int q=0;q<6;q++){
                    c[m][q] = random.nextInt(100);
                    bb.writeNumber(c[m][q],charGapX*b + 20,(int)(lineGapY*a+5),false);
                    delaySimple(mDelay);
                    if (restart == true) {
        ...
        if(mode == interactionMode){
            ...
            for(int k=0;k<5;k++){
                ...
                for(int l=0;l<6;l++){
                    ...
                    do{
                        bb.drawHighlightRectangle(charGapX * b +10, (int)(lineGapY*a+5), charGapX, 20,Color.BLUE);
                        bb.acceptInteger(2, charGapX * b +20, (int)(lineGapY*a+5));
                        waitTillDone(sDelay);
                        if (restart == true) return;  /* Exit to restart simulation */
                        c[k][l] = bb.getAcceptedInteger();
                        bb.clearHighlight();
                        if(c[k][l]<0)
                            bb.eraseArea(charGapX * b +10, (int)(lineGapY*a+5), charGapX, 40);
                    }while(c[k][l]<0);
                    if (restart == true) {
                        return;  /* Exit to restart simulation */
                    }
...
public void solveProblem()
{
        ...
        if ((mode == demoMode) || (mode == interactionMode) || (mode == guidedMode)) {   
            ...
            for(int d=0;d<5;d++){
                bb.eraseArea(charGapX*2, lineGapY *6 -20, 18 * charGapX, lineGapY*2);
                
               
                bb.writeString("Probability of earning "+s[i=random.nextInt(5)]+" per month and owning exactly "+n[j=random.nextInt(6)]+" vehicles ",charGapX*3,lineGapY*6 - 10 ,false);
                delaySimple(mDelay);
                bb.writeString(" = ",charGapX*3,lineGapY*7 -10,false);
                delaySimple(mDelay);
                if (restart == true) {
                    return;  /* Exit to restart simulation */
                }
                bb.drawLine(charGapX*4,lineGapY*7,charGapX*5 + 10,lineGapY*7,Color.WHITE,1);
                delaySimple(mDelay);
                ...
                if((mode == demoMode) || (mode == interactionMode)){
                    ...
                    bb.writeNumber(c[i][j],charGapX*4+10,lineGapY*7-20 ,false);
                    delaySimple(mDelay);
                    bb.writeNumber(sum,charGapX*4+5,lineGapY*7+5,false);
                    delayNextAction(mDelay);
                    if (stepMode == false) {
                        delaySimple(mDelay);
                    }
                    ...
                    bb.writeString(" = ",charGapX*5 + 30,lineGapY*7-10 ,false);
                    delaySimple(mDelay);
                    float res = (float) c[i][j]/sum;
                    
                    if(c[i][j] == 0 || sum == 0)
                        bb.writeNumber(0,charGapX*6+30,lineGapY*7-10,false);
                    else
                        bb.writeRealNumber(res,3,charGapX*6+30,lineGapY*7-10,false);
                    
                    delayNextAction(mDelay);
                    if (stepMode == false) {
                        delaySimple(2*mDelay);
                    }
                    ...
                    bb.drawHighlightRectangle(charGapX*4+5,lineGapY*7-25, charGapX, 20, Color.BLUE);

                    bb.acceptInteger(addDigits,charGapX*4+10,lineGapY*7-25 );
                    ...
                    if (inputDigit != c[i][j]) {   
                        addErrorRecord(charGapX*4+10,lineGapY*7-25, charGapX, 20);
                        isCorrect = false;
                    }
                    ...
                    bb.drawHighlightRectangle(charGapX*4,lineGapY*7+5, charGapX+10, 20, Color.BLUE);

                    bb.acceptInteger(addDigits+3,charGapX*4+5,lineGapY*7+5 );
                    ...
                    inputDigit = bb.getAcceptedInteger();
                    if (inputDigit != sum) {   
                        addErrorRecord(charGapX*4,lineGapY*7+5, charGapX+10, 20);
                        isCorrect = false;
                    }
                    ...
                    bb.drawHighlightRectangle(charGapX*6+15,lineGapY*7-20, 3*charGapX, 30, Color.BLUE);
                    
                    bb.acceptDecimalNumber(4, charGapX*6+30,lineGapY*7-10);
                    ...
                    float floatinputDigit = bb.getAcceptedDecimalNumber();
                    if (floatinputDigit != res) {   
                        addErrorRecord(charGapX*6+15,lineGapY*7-20, 3*charGapX, 30);
                        isCorrect = false;
                    }
                ...
                bb.setFontSize(15);
                bb.writeHighlightString("Probability of earning "+s[i=random.nextInt(5)]+" per month and owning exactly "+n[j=random.nextInt(6)]+" vehicles ",charGapX*3,lineGapY*6 - 10 ,false);
                delaySimple(2*mDelay);
                bb.writeHighlightString(" = ",charGapX*3,lineGapY*7 -10,false);
                delaySimple(2*mDelay);
                
                bb.drawHighlightRectangle(charGapX*4,lineGapY*7 - 20, 3*charGapX, 30, Color.BLUE);
          
                bb.acceptDecimalNumber(4, charGapX*4,lineGapY*7 - 30);
                ...
                float res = c[i][j]/(float)sum;
                if ( (answer<res-0.01) || (answer>res+0.01) ) {  
                    addErrorRecord(charGapX*4,lineGapY*7 - 30, 3*charGapX, 30);
                    isCorrect = false;
                }
